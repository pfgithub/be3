...
mod hotbar_drag_onto_folder_icon_has_no_target;
...
mod locked_challenge_completion_hotbar_slot_has_unlock_tooltip;
mod locked_challenge_completion_hotbar_slot_is_not_selectable;
...
mod unlocked_challenge_completion_hotbar_slot_selects_solution;
